(function () {
  ...
  style.textContent = [
    ...
    ".furora-iframe{width:100%;max-width:920px;height:640px;max-height:94dvh;border:none;border-radius:16px;overflow:hidden;box-shadow:0 32px 80px rgba(0,0,0,0.6);background:#1c1c1c;transition:height 0.2s ease}",
