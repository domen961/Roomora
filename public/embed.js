(function () {
  ...
  style.textContent = [
    ...
    ".roomora-iframe{width:100%;max-width:480px;height:90dvh;border:none;border-radius:16px;overflow:hidden;box-shadow:0 32px 80px rgba(0,0,0,0.6);background:#1c1c1c}",
    "@media(max-width:520px){.roomora-iframe{max-width:100%;height:100dvh;border-radius:0}.roomora-overlay{padding:0}}",
