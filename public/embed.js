(function () {
  ...
  style.textContent = [
    ...
    "@media(max-width:520px){.roomora-overlay{padding:0;align-items:stretch;justify-content:stretch}.roomora-iframe{max-width:100%;width:100%;height:100%;max-height:none;border-radius:0;transition:none}}",
